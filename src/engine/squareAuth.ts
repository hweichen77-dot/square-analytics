...
const SCOPES = 'MERCHANT_PROFILE_READ ORDERS_READ PAYMENTS_READ ITEMS_READ ITEMS_WRITE INVENTORY_READ TEAM_MEMBERS_READ TIMECARDS_READ CUSTOMERS_READ VENDOR_READ'
