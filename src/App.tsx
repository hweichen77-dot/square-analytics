  ...
  return (
    ...
    <div className="flex h-screen bg-stone-950 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="sticky top-0 z-30 bg-stone-950/90 backdrop-blur-sm border-b border-stone-800 px-4 lg:px-6 py-2.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden p-1.5 text-stone-200 hover:text-stone-200"
            ...
            <span className="font-display text-[13px] font-semibold text-stone-100 lg:hidden">Walley's Analytics</span>
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={() => setPaletteOpen(true)}
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 text-xs text-stone-200 border border-stone-700 hover:border-stone-600 hover:text-stone-300 transition-colors bg-stone-900/50"
            ...
            >
              ...
              <kbd className="ml-1 text-[10px] border border-stone-700 px-1 py-0.5">⌘K</kbd>
            </button>
            <DateRangePicker />
          </div>
        </div>
